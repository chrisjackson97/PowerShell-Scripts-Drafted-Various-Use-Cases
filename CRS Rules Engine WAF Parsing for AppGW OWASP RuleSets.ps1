...
resoureces.This provided script will serve as an example of how to actively parse through the output given by PS cmdlet Get-AzApplicationGatewayAvailableWafRuleSets
