...
<# The Intent of this Script is to utilize PowerShell 5.1 or 7.0 scripting to create a user, assign the user to a new security group, and then assign the security
 group relavent RBAC. For PowerShell, please note that while the commands for creation are straight-forward,there is alot of nuance in the proper modules being set up.
